...
| `range`    | `number`, `integer`   | Maximum and minimum value conditions that a numeric field must pass.                                                                                                                                                                                                                                                                                                                                                           | [RangeRule](#rangerule-data-structure)                   | `{ min: 5, exclusiveMax: 10 }` Represents an integer from 5-9.                                         |
