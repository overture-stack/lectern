...
export const Default: Story = {
	args: {
		accordionItems: [
			...
			{
				title: '{An_unnecessarily_lengthy_name_for_a_schema:with_it’s_name_include_of_course}',
				openOnInit: false,
				description:
					'{Schema: description} Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Cillum ex qui pariatur sint est elit amet commodo dolore duis exercitation cupidatat anim deserunt. Commodo mollit labore et qui sit consectetur laborum eiusmod.',
				content:
